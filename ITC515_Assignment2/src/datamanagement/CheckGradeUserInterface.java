...
public class CheckGradeUserInterface extends javax.swing.JFrame implements InterfaceUnitLister, InterfaceStudentLister {
	private CheckGradeControl control;
	private javax.swing.DefaultComboBoxModel unitModel;
	private javax.swing.DefaultComboBoxModel recordModel;
	float assignment1;
	float assignment2;
	float exam;
	Integer selectedId;
	...
	public CheckGradeUserInterface(CheckGradeControl control) {
		...
		recordModel = new javax.swing.DefaultComboBoxModel(new String[0]);
		initComponents();
		jComboBox1.setModel(unitModel);
		jComboBox2.setModel(recordModel);
		jlabel6.setText("");
	}
	...
	private void jComboBox2ItemStateChanged(java.awt.event.ItemEvent evt) {// GEN-FIRST:event_jComboBox2ItemStateChanged
		...
		if (evt.getStateChange() == java.awt.event.ItemEvent.SELECTED) {
			if (cS.equals((String) jComboBox2.getItemAt(0))) {
				...
				control.studentSelected(selectedId);
			} else {
				selectedId = new Integer(cS.split("\\s")[0]);
			}
			control.studentSelected(selectedId);
		}
	...
	private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton3ActionPerformed
		...
		// lblErrMsg.setText("");
		try {
			String string = control.checkGrade(assignment1, assignment2, exam);
	...
	private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton2ActionPerformed
		...
		jlabel6.setText("");
		try {
			control.saveGrade(aassignment1, assignment2, exam);
	...
	public void clearStudents() {
		...
		recordModel.addElement("<none selected>");
	}
